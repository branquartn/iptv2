...
import com.nicotv.iptv2.data.network.AddMediaRequest
import com.nicotv.iptv2.data.network.CatalogApi
import com.nicotv.iptv2.data.network.LibraryMovie
import com.nicotv.iptv2.data.network.LibrarySeries
import com.nicotv.iptv2.data.network.NicoTvApi
import com.nicotv.iptv2.data.network.PlaybackProgress
import com.nicotv.iptv2.data.network.SeenState
import com.nicotv.iptv2.data.network.StateUpdateRequest
import com.nicotv.iptv2.data.network.TmdbApi
import com.nicotv.iptv2.data.network.model.TmdbCredits
import com.nicotv.iptv2.data.network.model.TmdbMovieResult
...
class MediaRepository(
    ...
    private val finishedMoviesCache: com.nicotv.iptv2.util.FinishedMoviesCache
) {
    ...
    suspend fun otherDevicesPresence(bearer: String): List<com.nicotv.iptv2.data.network.PresenceItem> = withContext(Dispatchers.IO) {
    ...
    suspend fun remoteReportTracks(report: com.nicotv.iptv2.data.network.RemoteTracksReport, bearer: String) = withContext(Dispatchers.IO) {
