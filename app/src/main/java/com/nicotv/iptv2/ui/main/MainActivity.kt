...
import com.nicotv.iptv2.data.network.PresenceItem
import com.nicotv.iptv2.databinding.ActivityMainBinding
import com.nicotv.iptv2.ui.downloads.DownloadsActivity
import com.nicotv.iptv2.ui.favorites.FavoritesActivity
import com.nicotv.iptv2.ui.login.LoginActivity
...
import com.nicotv.iptv2.ui.users.UsersActivity
...
class MainActivity : com.nicotv.iptv2.ui.common.BaseActivity() {
    ...
    private fun startOtherDevicePresencePoll() {
        ...
        binding.btnRemote.setOnClickListener {
            startActivity(android.content.Intent(this, com.nicotv.iptv2.ui.remote.RemoteControlActivity::class.java))
        }
