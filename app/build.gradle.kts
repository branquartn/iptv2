...
val appChangelog = "Accueil : le fond aléatoire ne fige plus l'app pendant plusieurs secondes sur un gros catalogue (calcul déporté hors du thread principal)."
