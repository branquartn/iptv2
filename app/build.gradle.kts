...
val appChangelog = "Catégories affichées dans l'ordre de la playlist (comme sur le panel) et défilement rapide à la télécommande (2 appuis = 5 catégories). ⚠️ Recharge ta playlist après cette mise à jour."
