...
val appChangelog = "Favoris s'ouvre instantanément (ne parcourt plus tout le catalogue). ⚠️ Recharge ta playlist si ce n'est pas déjà fait depuis la mise à jour précédente."
